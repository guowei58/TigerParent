...
export const MATH_CURRICULUM: LevelDef[] = [
  {
    ...
    skills: [
      { title: "Counting to 20", description: "Count forward and backward to 20", targetMedianSeconds: 8, minProblems: 80, fluency: true },
      { title: "Counting to 100", description: "Count by ones to 100", targetMedianSeconds: 12, minProblems: 60 },
      ...
      { title: "Comparing Numbers", description: "Greater than, less than, equal to", targetMedianSeconds: 15, minProblems: 60 },
      { title: "Shapes & Patterns", description: "Identify 2D shapes and simple patterns", targetMedianSeconds: 20, minProblems: 50 },
      { title: "Telling Time Basics", description: "Hour and half-hour clocks", targetMedianSeconds: 25, minProblems: 50 },
      { title: "Measurement Length", description: "Compare and measure length", targetMedianSeconds: 25, minProblems: 50 },
      { title: "Simple Word Problems", description: "Join and separate stories within 10", targetMedianSeconds: 35, minProblems: 60 },
    ],
  },
  {
    grade: 2,
    title: "Grade 2 Math Mastery",
    skills: [
      ...
      { title: "Skip Counting", description: "Count by 2s, 5s, and 10s", targetMedianSeconds: 12, minProblems: 70, fluency: true },
      { title: "Two-Digit Addition", description: "Add two-digit numbers without regrouping", targetMedianSeconds: 25, minProblems: 70 },
      { title: "Two-Digit Subtraction", description: "Subtract two-digit numbers without regrouping", targetMedianSeconds: 25, minProblems: 70 },
      { title: "Place Value to 100", description: "Tens and ones through 100", targetMedianSeconds: 20, minProblems: 60 },
      { title: "Money", description: "Count coins and make change", targetMedianSeconds: 30, minProblems: 60 },
      { title: "Intro Multiplication", description: "Groups of 2, 5, and 10", targetMedianSeconds: 20, minProblems: 80, fluency: true },
      { title: "Data & Graphs", description: "Bar graphs and pictographs", targetMedianSeconds: 30, minProblems: 50 },
      { title: "Geometry Shapes", description: "Attributes of 2D and 3D shapes", targetMedianSeconds: 25, minProblems: 50 },
    ],
  },
  {
    grade: 3,
  ...
  },
  {
    ...
    skills: [
      { title: "Linear Equations", description: "Solve one- and two-step linear equations", targetMedianSeconds: 45, minProblems: 70 },
      { title: "Systems of Equations", description: "Solve simple systems by substitution", targetMedianSeconds: 50, minProblems: 60 },
      { title: "Functions & Graphs", description: "Identify functions and interpret graphs", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Scientific Notation", description: "Convert and compute with scientific notation", targetMedianSeconds: 35, minProblems: 60 },
      { title: "Exponents & Roots", description: "Laws of exponents and square roots", targetMedianSeconds: 35, minProblems: 70 },
      { title: "Pythagorean Theorem", description: "Find missing sides of right triangles", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Transformations", description: "Translations, rotations, reflections", targetMedianSeconds: 40, minProblems: 50 },
      { title: "Scatter Plots", description: "Trend lines and bivariate data", targetMedianSeconds: 40, minProblems: 50 },
      { title: "Irrational Numbers", description: "Approximate and compare irrationals", targetMedianSeconds: 35, minProblems: 50 },
    ],
  },
  {
    grade: 9,
    title: "Grade 9 Algebra I",
    skills: [
      { title: "Linear Functions", description: "Slope-intercept form and rate of change", targetMedianSeconds: 40, minProblems: 70 },
      { title: "Quadratic Equations", description: "Factor and solve quadratics", targetMedianSeconds: 45, minProblems: 70 },
      { title: "Polynomial Operations", description: "Add, subtract, and multiply polynomials", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Factoring", description: "GCF, trinomials, and difference of squares", targetMedianSeconds: 45, minProblems: 70 },
      { title: "Radicals & Exponents", description: "Simplify radical and exponential expressions", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Inequalities", description: "Solve and graph linear inequalities", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Statistics & Regression", description: "Lines of best fit and correlation", targetMedianSeconds: 40, minProblems: 50 },
      { title: "Exponential Growth", description: "Model growth and decay", targetMedianSeconds: 40, minProblems: 60 },
    ],
  },
  {
    grade: 10,
    ...
    skills: [
      { title: "Geometric Proofs", description: "Two-column proofs with basic theorems", targetMedianSeconds: 50, minProblems: 50 },
      { title: "Similarity & Congruence", description: "Prove and apply similarity ratios", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Right Triangle Trigonometry", description: "Sine, cosine, tangent ratios", targetMedianSeconds: 45, minProblems: 70 },
      { title: "Circle Theorems", description: "Arcs, chords, and inscribed angles", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Area & Volume 3D", description: "Surface area and volume of solids", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Coordinate Geometry", description: "Distance, midpoint, and slope proofs", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Conditional Probability", description: "Two-way tables and compound events", targetMedianSeconds: 40, minProblems: 50 },
    ],
  },
  {
    grade: 11,
    ...
    skills: [
      { title: "Logarithms", description: "Properties and solving log equations", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Exponential Functions", description: "Graph and model exponential functions", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Sequences & Series", description: "Arithmetic and geometric sequences", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Rational Expressions", description: "Simplify and solve rational equations", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Complex Numbers", description: "Operations with imaginary numbers", targetMedianSeconds: 40, minProblems: 50 },
      { title: "Probability & Combinatorics", description: "Permutations, combinations, probability", targetMedianSeconds: 40, minProblems: 60 },
      { title: "Trigonometric Functions", description: "Unit circle and trig graphs", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Conic Sections", description: "Parabolas, ellipses, and hyperbolas", targetMedianSeconds: 45, minProblems: 50 },
    ],
  },
  {
    grade: 12,
    title: "Grade 12 Pre-Calculus",
    skills: [
      { title: "Limits & Continuity", description: "Evaluate limits and continuity", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Derivatives", description: "Power rule and basic differentiation", targetMedianSeconds: 50, minProblems: 60 },
      { title: "Integrals Introduction", description: "Area under curves and antiderivatives", targetMedianSeconds: 50, minProblems: 50 },
      { title: "Trigonometric Identities", description: "Prove and apply trig identities", targetMedianSeconds: 45, minProblems: 60 },
      { title: "Vectors & Matrices", description: "Vector operations and matrix algebra", targetMedianSeconds: 45, minProblems: 50 },
      { title: "SAT Math Review", description: "Mixed SAT-style fluency", targetMedianSeconds: 45, minProblems: 80, fluency: true },
    ],
  },
];
...
export const ENGLISH_CURRICULUM: LevelDef[] = [
  {
    grade: 1,
    title: "Grade 1 Reading & Language",
    skills: [
      { title: "Letter Sounds", description: "Match letters to beginning sounds", minProblems: 60, fluency: true },
      { title: "Sight Words", description: "Read high-frequency words", minProblems: 80, fluency: true },
      { title: "Rhyming Words", description: "Identify and produce rhymes", minProblems: 60, fluency: true },
      { title: "Main Idea", description: "Main idea of short passages", minProblems: 50 },
      { title: "Supporting Details", description: "Key details in short texts", minProblems: 50 },
      { title: "Capitalization", description: "Capitalize sentences and names", minProblems: 60, fluency: true },
      { title: "Punctuation Basics", description: "Periods, question marks, exclamation points", minProblems: 50 },
      { title: "Sentence Structure", description: "Complete sentences and word order", minProblems: 50 },
      { title: "Vocabulary in Context", description: "Simple context clues", minProblems: 50 },
    ],
  },
  {
    grade: 2,
    title: "Grade 2 Reading & Language",
    skills: [
      { title: "Reading Comprehension", description: "Fiction and nonfiction passages", minProblems: 50 },
      { title: "Inference", description: "Draw conclusions from text", minProblems: 50 },
      { title: "Phonics & Decoding", description: "Blend sounds to read words", minProblems: 60, fluency: true },
      { title: "Nouns & Verbs", description: "Identify nouns and action verbs", minProblems: 50 },
      { title: "Adjectives", description: "Describe nouns with adjectives", minProblems: 50 },
      { title: "Sentence Types", description: "Statements, questions, commands", minProblems: 50 },
      { title: "Commas", description: "Commas in lists and dates", minProblems: 50 },
      { title: "Spelling Patterns", description: "Common spelling rules", minProblems: 60, fluency: true },
      { title: "Sequence", description: "Order of events in stories", minProblems: 50 },
    ],
  },
  {
    grade: 3,
  ...
  {
    grade: 8,
    title: "Grade 8 Reading & Language",
    skills: [
      { title: "Analytical Reading", description: "Analyze complex texts", minProblems: 50 },
      { title: "Claims and Evidence", description: "Evaluate arguments and evidence", minProblems: 50 },
      { title: "Argument Writing", description: "Structured persuasive writing", minProblems: 50 },
      { title: "Grammar Precision", description: "Advanced grammar rules", minProblems: 50 },
      { title: "Vocabulary in Context", description: "Academic vocabulary in context", minProblems: 50 },
      { title: "Text Structure", description: "Compare text structures", minProblems: 50 },
      { title: "Literary Analysis", description: "Analyze literary elements", minProblems: 50 },
      { title: "Research & Citations", description: "Cite sources properly", minProblems: 50 },
      { title: "Media Literacy", description: "Evaluate media messages", minProblems: 50 },
    ],
  },
  {
    grade: 9,
    title: "Grade 9 Reading & Language",
    skills: [
      { title: "Essay Structure", description: "Intro, body, conclusion", minProblems: 50 },
      { title: "Literary Devices", description: "Metaphor, symbolism, irony", minProblems: 50 },
      { title: "Poetry Analysis", description: "Analyze form and figurative language", minProblems: 50 },
      { title: "Narrative Writing", description: "Craft engaging narratives", minProblems: 50 },
      { title: "Verb Tense & Agreement", description: "Consistent tense and subject-verb agreement", minProblems: 50 },
      { title: "Active vs Passive Voice", description: "Identify and revise voice", minProblems: 50 },
      { title: "Vocabulary Development", description: "Greek and Latin roots", minProblems: 60, fluency: true },
      { title: "Research Skills", description: "Evaluate sources and take notes", minProblems: 50 },
    ],
  },
  {
    grade: 10,
    title: "Grade 10 Reading & Language",
    skills: [
      { title: "Rhetorical Analysis", description: "Analyze author's rhetorical choices", minProblems: 50 },
      { title: "Synthesis", description: "Combine multiple sources", minProblems: 50 },
      { title: "Persuasive Writing", description: "Build convincing arguments", minProblems: 50 },
      { title: "Theme Analysis", description: "Analyze themes across texts", minProblems: 50 },
      { title: "Parallel Structure", description: "Balanced sentence parts", minProblems: 50 },
      { title: "Formal Writing", description: "Academic tone and style", minProblems: 50 },
      { title: "Counterarguments", description: "Address opposing views", minProblems: 50 },
      { title: "World Literature", description: "Analyze global literary texts", minProblems: 50 },
    ],
  },
  {
    grade: 11,
    title: "Grade 11 Reading & Language",
    skills: [
      { title: "American Literature", description: "Analyze American literary works", minProblems: 50 },
      { title: "Critical Analysis", description: "Deep literary criticism", minProblems: 50 },
      { title: "Thesis Statements", description: "Clear arguable thesis", minProblems: 50 },
      { title: "MLA Citations", description: "In-text and works cited format", minProblems: 50 },
      { title: "Connotation & Denotation", description: "Word shades of meaning", minProblems: 50 },
      { title: "Satire & Irony", description: "Identify satire and verbal irony", minProblems: 50 },
      { title: "Research Papers", description: "Long-form research writing", minProblems: 50 },
      { title: "College Essay Prep", description: "Personal statement writing", minProblems: 50 },
    ],
  },
  {
    grade: 12,
    title: "Grade 12 Reading & Language",
    skills: [
      { title: "British Literature", description: "Analyze British literary works", minProblems: 50 },
      { title: "Literary Criticism", description: "Apply critical lenses", minProblems: 50 },
      { title: "Advanced Synthesis", description: "Synthesize complex sources", minProblems: 50 },
      { title: "Rhetorical Devices", description: "Ethos, pathos, logos", minProblems: 50 },
      { title: "AP Literature Skills", description: "College-level close reading", minProblems: 50 },
      { title: "Capstone Writing", description: "Extended argumentative essays", minProblems: 50 },
      { title: "Independent Research", description: "Self-directed research projects", minProblems: 50 },
    ],
  },
];
